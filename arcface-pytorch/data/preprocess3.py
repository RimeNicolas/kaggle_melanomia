...
def preprocess_dataset3(data_list_file, dir_imgs_old, dir_imgs_new):
...
def create_dataset():
    ...
    preprocess_dataset3(data_list_file, dir_imgs_old, dir_imgs_new)


def create_testset():
    dir_imgs_old = r'C:\Users\Nrime\Documents\Kaggle_dataset\melanoma\original\jpeg\test'
    dir_imgs_new = r'C:\Users\Nrime\Documents\Kaggle_dataset\melanoma\dataset3\jpeg_test'
...
def resize_imgs():
    ...
    dir_imgs_test = r'C:\Users\Nrime\Documents\Kaggle_dataset\melanoma\dataset3\jpeg_test\img'
